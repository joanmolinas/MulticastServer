...
public class ConsoleInterface {
    ...
    /**
     * Constructor per defecte. Els objectes així instanciats llegiran les dades
     * del teclat i escriuran els missatges a la pantalla
     */
     ...
     * necessari i incorporar tantes lectures separades per retorns de línia 
     * com calgui.
     ...
     * introducció d'un valor numèric des del teclat. Si l'usuari entre 
     * valors no numèrics, mostrarà una missatge d'error i requerirà una nova 
     * introducció.
    ...
    /**
     * Mostrarà per pantalla el missatge rebut com a primer paràmetre i 
     * esperarà la introducció d'un caràcter des del teclat. Si l'usuari entra 
     * un caràcter igual al segon paràmetre, es retornarà cert. En cas contrari 
     * es retornnrà fals.
     * El tercer paràmetre permet indicar si es desitja fer un canvi a 
     * màjuscules o minúscules de la tecla premuda per lusuari. El valor 
     * TO_UPPER_CASE (2) canviarà sempre el valor introduït a majúscules abans 
     * de fer la comparació. El valor TO_LOWER_CASE (1)pasarà el valor a 
     * minúscules i qualsevol altre valor no realitzarà cap canvi.
     * @param message Missatge a mostrar per la pantalla abans de demanar el 
     ...
     * @param changeCase. És un valor numèric que indica si cal canviar el valor 
     * de l'usuari a majúscules o minúscules.
     * @return el valor numèric introduït des del teclat.
     */
    ...
    /**
     * Retorna cert si hi ha caracter disponible al buffer del teclat. Aquest 
     * mètode no es bloquejant, pel que pot ser molt útil per sistemes que no 
     * es puguin bloquejar esperant la resposta de l'usuari.
     * @return 
     */
